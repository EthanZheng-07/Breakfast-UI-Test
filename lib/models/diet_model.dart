...
class DietModel {
  ...
  static List < DietModel > getDiets() {
    ...
    diets.add(
      DietModel(name: 'Canai Bread', iconPath: 'assets/icons/canai-bread.svg', level: 'Easy', duration: '20mins', calorie: '230kCal', boxColor: Color(0xffEEA4CE), viewIsSelected: false)
    );
